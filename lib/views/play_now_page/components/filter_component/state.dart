...
class FilterConnector extends ConnOp<PlayNowPageState, FilterState> {
  @override
  FilterState get(PlayNowPageState state) {
    final FilterState filterState = state.filterState;
    return filterState;
  }

  @override
  void set(PlayNowPageState state, FilterState subState) {
